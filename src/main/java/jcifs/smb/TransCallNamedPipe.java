...
class TransCallNamedPipe extends SmbComTransaction {
    ...
    private static final Logger log = Logger.getLogger(TransCallNamedPipe.class);

    private byte[] pipeData;
    private int pipeDataOff, pipeDataLen;


    TransCallNamedPipe ( Configuration config, String pipeName, byte[] data, int off, int len ) {
        super(config);
        this.name = pipeName;
        this.pipeData = data;
        ...
        this.subCommand = TRANS_CALL_NAMED_PIPE;
